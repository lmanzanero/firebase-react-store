...
export default function SearchOrderInput({ referenceNumber }) {
  return (
    <div className="min-h-screen flex justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-3">
          ...
          <input type="text" id="referenceNumber" name="refenceNumber" value={referenceNumber} placeholder="DG-5001-8521-993" class="p-3.5 text-sm w-full"/>
        </div>
